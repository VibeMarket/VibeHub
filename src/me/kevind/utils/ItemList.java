...
public final class ItemList {
    ...
    public static final ItemStack BI_ARMOR = new ItemMaker(Material.PURPLE_WOOL).name("&dBi&5sexual &7Armor").lore("&7Left click to equip", "&7Right click to unequip").build();
